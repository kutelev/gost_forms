...
class Form : public Element {
    public:
        ...
        int setField(const unsigned int field_num,
            const unsigned int sub_field, const char*const text);
...
class FormDrawing : public Frame, public FormA1, public FormA3, public FormB, public FormC,
    public FormD
{
    public:
        virtual ~FormDrawing() {}
...
class FormText : public Frame, public FormA2, public FormA3, public FormB, public FormC,
    public FormD
{
    public:
        virtual ~FormText() {}
...
class FormTextPlus : public Frame, public FormA2, public FormA3, public FormB, public FormC,
    public FormD
{
    public:
